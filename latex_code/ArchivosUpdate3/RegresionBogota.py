...
def prediBog(meses,cant,hoy):
    ...
    ax.set_title('REGRESIÓN LINEAL DATOS DE COVID EN BOGOTÁ')
    ...
    fig8.tight_layout()
    fname = "RegresionLineal_Covid_Bogota_" + hoy + ".png"
    ...
    ax.set_title('PROYECCIÓN DE CONTAGIOS POR MES EN BOGOTÁ')
    ...
    fig9.tight_layout()
    fname = "Proyeccion_Covid_Bogota_" + hoy + ".png"
    pt.savefig(fname, bbox_inches='tight')
    pt.show()
